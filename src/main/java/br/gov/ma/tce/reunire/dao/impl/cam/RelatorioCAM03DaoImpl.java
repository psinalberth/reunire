...
public class RelatorioCAM03DaoImpl extends PrestacaoDaoImpl<RelatorioCAM03VO> implements DemonstrativoDao<RelatorioCAM03VO> {
	...
	public List<RelatorioCAM03VO> recuperaDados(Map<String, Object> params) {
		...
		String sql = "select cam03.unidade_id, date(cam03.data_ato) data_ato, cam03.tipo_ato, cam03.valor, cam03.dotacao_inicial " + 
				"from prestacao.cam03 cam03 " + 
				"where cam03.unidade_id in (:unidade) " + 
				"group by cam03.unidade_id, data_ato, cam03.tipo_ato, cam03.valor, cam03.dotacao_inicial " + 
				"order by cam03.unidade_id";
		...
		for(Object[] l : lista) {
			...
			relatorio.setTipoAto(l[2].toString());
